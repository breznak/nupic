...
"""
OPF file for running HTM experiments (anomaly detection) on 
synthetic datasets (white noise, sine wave, step function, constant fn. etc), 
...
config = {
    ...
    'modelParams': {
        ...
        'anomalyParams': {
           'mode': 'weighted', # pure(=default) / weighted / likelihood
